            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">{{$search->category_name}}</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-xs-12">
                    <div class="single-pg-item">
                        <div class="single-pg-header">
                            <h4>{{$search->post_title}} </h4>
                            <p>আপডেট: {{$search->post_cur_date}}</p>
                        </div>
                        ...
                        <div id="news_print">
                            <div class="single-pg-mg">
                                <img src="{{asset($search->post_image)}}" alt="" class="img-fluid">
                            </div>

                            <div class="single-pg-para news_paragraph">
                                <p>{!! $search->long_description !!}</p>
                            </div>
                        </div>
